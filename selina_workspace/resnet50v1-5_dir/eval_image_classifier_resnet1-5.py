...
import sys
sys.path.append(r"$HOME/selina_temp_workspace/sima-project/models/research/slim/datasets");from dataset_factory.py import dataset_factory #from datasets

sys.path.append(r"$HOME/selina_temp_workspace/sima-project/models/research/slim/nets");from nets_factory.py import nets_factory #from nets

sys.path.append(r"$HOME/selina_temp_workspace/sima-project/models/research/slim/preprocessing");from preprocessing_factory.py import preprocessing_factory #from preprocessing
...
#         self.load_graph(model_filepath = self.model_filepath)
    ...
    def load_graph(self):
        ...
        with self.graph.as_default():
            # Define input tensor
            self.input = tf.placeholder(np.float32, shape = [None, 224, 224, 3], name='input_tensor')
        ...
        def test(self, data):
            ...
            output_tensor = self.graph.get_tensor_by_name("softmax_tensor:0")
